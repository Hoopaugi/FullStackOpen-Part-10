...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent(formatInThousands(1619))
      expect(firstRepositoryItem).toHaveTextContent(formatInThousands(21856))
      ...
      expect(secondRepositoryItem).toHaveTextContent(formatInThousands(1760))
